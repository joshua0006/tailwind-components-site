    ...
    const calculateTotal = () => {
      return carts.reduce((total, cartItem) => {
        ...
        if (product && typeof product.price === 'number') {
          ...
          console.error(`Product not found or invalid price for productId: ${cartItem.productId}`);
          return total;
        }
      }, 0);
    };
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <input className='w-auto h-8 bg-slate-300 pl-2 rounded-lg' type="text" placeholder='Search here' />
                {/* Search */}
                    ...
                    <div className="mt-8">
                      <div className="flow-root">
                        <ul role="list" className="-my-6 divide-y divide-gray-200">
                          {carts.length > 0 ? (
                            products
                              .filter(product => carts.some(cartItem => cartItem.productId === product.id))
                              .map(product => {
                                const cartItem = carts.find(cartItem => cartItem.productId === product.id);
                                return (
                                    ...
                                    <div className="ml-4 flex flex-1 flex-col">
                                      <div>
                                        <div className="flex justify-between text-base font-medium text-gray-900">
                                          <h3><Link to={product.href}>{product.name}</Link></h3>
